...
from matchzoo.models.multimodal_rhp import (
	...
	CommonSpaceMultimodalLayernormBertRHPNet3
)
...
class CommonSpaceMultimodalLayernormBertRHP3(MultimodalRHP):
	def build_model(self):
		self.model = CommonSpaceMultimodalLayernormBertRHPNet3(
			self.config, self.preprocessor, self.stage)

class BigDataCommonSpaceMultimodalLayernormRHP2(BigDataMultimodalRHP):
    def build_model(self):
        self.model = MultimodalLayernormRHPNet2(
            self.config, self.preprocessor, self.stage)
