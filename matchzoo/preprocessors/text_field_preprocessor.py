...
class TextFieldPreprocessor(BasePreprocessor):
    ...
    @classmethod
    def _default_units_bert(cls) -> list:
...
#            data_pack = data_pack.apply_on_field(chain_transform(_self._units), field=f,
...
#        return self
    ...
    def transform(self, data_pack: DataPack, verbose: int = 1) -> DataPack:
        ...
        for f, m in self._field_w_mode:
            data_pack.apply_on_field(self._tokenizer.encode, field=f, mode=m, inplace=True, verbose=verbose)
